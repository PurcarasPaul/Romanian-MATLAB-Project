...
curba2_grad2=[48,75,98;45,58,5];
curba3_grad2=[98,125,152;5,58,45];
curba4_grad2=[152,172,199;45,82,60];
...
curba1_grad5=[199,205,122,122,155,145;60,130,165,165,155,140];
curba2_grad5=[1,-1,74,74,45,51;60,130,165,165,155,140];
...
%Functii pentru setarea fundalului galben
set(gca,'Color','y')
set(gcf,'Color','y')